        ...
        with sqlite3.connect(cls.DB_FILE) as conn:
            ...
            if count == 0:
                raw_data = [
                    ...
                    ("111.09.0.056", "111.08.0.047", "Từ Hữu Nhung", "", "Bà Nguyễn Thị Tạo", "1961", "2024", "", "Con ông Hiền. Sinh hạ: Từ Ngọc Hoàn, Từ Ngọc Hải.", "", ""),
                    ...
                    ("111.09.0.066", "111.08.0.051", "Từ Hữu Hùng", "", "Uông Thị Hiền", "", "", "", "Con ông Tường. Sinh hạ: Từ Uông Gia Bảo, Từ Uông Gia Khang.", "", ""),
                    ...
                    ("122.10.0.002", "122.09.0.001", "Từ Hữu Thoả", "", "Trần Thị Sơn", "", "", "", "Con ông Từ Hữu Tuyến. Lấy vợ người Hương Sơn.", "", ""),
                    ("122.10.0.003", "122.09.0.001", "Từ Hữu Thành", "", "Nguyễn Thị Vân", "", "", "", "Con ông Từ Hữu Tuyến. Lấy vợ người Hương Sơn.", "", ""),
                    ("122.10.0.004", "122.09.0.001", "Từ Hữu Tuyền", "", "Vi Thị Ngọc", "", "", "", "Con ông Từ Hữu Tuyến. Lấy vợ người Nghệ An.", "", ""),
                    ...
                    ("122.10.0.007", "122.09.0.002", "Từ Hữu Hùng", "", "Bỏ vợ", "", "", "", "Con ông Từ Hữu Cừ.", "Không có con", ""),
                    ("122.10.1.008", "122.09.0.002", "Từ Thị Dũng", "", "Trần Định", "", "", "", "Con ông Từ Hữu Cừ. Lấy chồng người trong xã", "", ""), 
                    ("122.10.0.009", "122.09.0.002", "Từ Hữu Kiên", "", "", "", "", "", "Con ông Từ Hữu Cừ", "Chết sớm", ""),

                    ("122.10.0.010", "122.09.0.002", "Từ Hữu Cường", "", "Nguyễn Thị Hiền", "", "", "", "Con ông Từ Hữu Cừ. Lấy vợ người Bình Định. Sinh hạ: Từ Thị Phương, Từ Thị Thảo, Từ Hữu Hiếu", "", ""),
                    ("122.10.1.011", "122.09.0.002", "Từ Thị Phú", "", "Ông Hào", "", "", "", "Con ông Từ Hữu Cừ. Lấy chồng về Mỹ Lộc.", "", ""),
                    ("122.10.1.012", "122.09.0.002", "Từ Thị Hựu", "", "Ông Thanh", "", "", "", "Con ông Từ Hữu Cừ. Lấy chồng về Trung Lộc", "", ""),
                    ("122.10.1.013", "122.09.0.002", "Từ Thị Hạnh", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Cừ.", "", ""),

                    ("122.10.0.014", "122.09.0.002", "Từ Hữu Phúc", "", "Nguyễn Thị Luận", "", "", "", "Con ông Từ Hữu Cừ. Sinh hạ: Từ Thị Khánh Ngọc, Từ Thị Hoài An.", "", ""),
                    ("122.10.0.015", "122.09.0.002", "Từ Hữu Vựng", "", "Bà Trần Thị Hiền", "", "", "", "Con ông Từ Hữu Cừ. Vợ là Bà Hiền ở Mỹ Lộc. Sinh hạ: Từ Hữu Đức, Từ Thị Bảo Châu", "", ""),
                    ...
                    ("258.09.1.122", "258.09.0.069", "Từ Tú Linh", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Chín.", "", ""),
                    ("258.09.1.123", "258.09.0.069", "Từ Tú Phương", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Chín.", "", ""),
                    ...
                    # CHI 2
                    # ------------------------------------   
                    ("122.11.1.020", "122.10.0.010", "Từ Thị Phương", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Cường.", "", ""),
                    ("122.11.1.021", "122.10.0.010", "Từ Thị Thảo", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Cường.", "", ""),
                    ("122.11.0.022", "122.10.0.010", "Từ Hữu Hiếu", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Cường.", "", ""),
                    ("122.11.1.024", "122.10.0.014", "Từ Thị Khánh Ngọc", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Phúc.", "", ""),
                    ("122.11.1.025", "122.10.0.014", "Từ Thị Hoài An", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Phúc.", "", ""),
                    ("122.10.0.028", "122.10.0.015", "Từ Hữu Đức", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Vựng", "", ""),
                    ("122.10.1.029", "122.10.0.015", "Từ Thị Bảo Châu", "", "Đang cập nhật", "", "", "", "Con ông Từ Hữu Vựng", "", ""),
...
class QuanTriHinhAnh:
    ...
    def xu_ly_va_nen_anh(uploaded_file, save_path):
        try:
            # Đọc tệp ảnh tải lên từ bất kỳ nguồn nào (máy chụp hoặc album)
            img = Image.open(uploaded_file)
            
            # Tự động xoay ảnh đúng chiều dựa trên EXIF nếu có
            try:
                img = ImageOps.exif_transpose(img)
            except Exception:
                pass
                
            # Ép kiểu về RGB để tương thích tuyệt đối với chuẩn lưu JPEG
            if img.mode in ("RGBA", "P"):
                img = img.convert("RGB")
            elif img.mode != "RGB":
                img = img.convert("RGB")
                
            # Thu nhỏ kích thước tối đa 500x500 để nhẹ dung lượng nhưng vẫn nét chân dung
            img.thumbnail((500, 500), Image.Resampling.LANCZOS)
            
            # Lưu tệp với chất lượng tối ưu
            img.save(save_path, "JPEG", quality=85)
            return True
        except Exception as e:
            print(f"⚠️ Chi tiết lỗi xử lý ảnh từ album: {e}")
            return False
...
class SoChiHuyGiaoDien:
        ...
        with col_nav:
            ...
            if cho_phep_tai_anh:
                with st.expander("📷 Tự tải/Cập nhật ảnh chân dung của bạn"):
                    ...
                    # 🟢 SỬA TẠI ĐÂY: Mở rộng type nhận thêm định dạng HEIC/HEIF từ album iPhone/Android


                    up_file_user = st.file_uploader(
                        "Chọn ảnh từ máy hoặc album (JPG, PNG, HEIC):", 
                    ...
                    if up_file_user is not None:
                        if st.button("💾 Xác nhận lưu ảnh lên hệ thống", key=f"btn_save_{curr_person['ID']}"):
                            ...
                            # Đặt tên file chuẩn theo cú pháp hệ thống: "[ID] [Họ Tên].jpg"
    ...
    def render_quantri(df):
        ...
        if mat_khau == "admin12345":
            ...
            # Đọc trạng thái hiện tại từ SQLite
            with sqlite3.connect(KhoDuLieuSQL.DB_FILE) as conn:
                cursor = conn.cursor()
                cursor.execute("SELECT GiaTri FROM CauHinhHeThong WHERE Khoa = 'cho_phep_tai_anh'")
                res = cursor.fetchone()
            ...
            # Công tắc điều khiển cập nhật thẳng vào CSDL
            cho_phep_moi = st.toggle(
                "Mở chế độ cho phép mọi người tự tải ảnh chân dung", 
                value=current_val,
                key="toggle_cho_phep_tai_anh_db"
            )
            ...
            if cho_phep_moi:
                st.warning("⚠️ Đang MỞ: Tất cả mọi người ở mọi miền Tổ quốc đều có thể tự tải ảnh chân dung lên hệ thống.")
            else:
            ...
            st.warning("Vui lòng nhập mật khẩu quản trị vào khung bên trái để mở khóa các tính năng quản trị.")
