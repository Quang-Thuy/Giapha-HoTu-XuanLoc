...
# PHIÊN BẢN TỔNG LỰC NGUYÊN KHỐI - CHUẨN MỰC SQLITE & TỐI ƯU DI ĐỘNG
# ==============================================================================
        ...
        with sqlite3.connect(cls.DB_FILE) as conn:
            ...
            if count == 0:
                raw_data = [
                    ...
                    (244, 133, "Từ Thị Ba Điêm", "", "Nữ", 8, "Cura Giáp - Chi 1 Giáp (Cụ Liệu)", "Ba Điêm (giữa làng)", "", "", "", "", ""),
            ...
            <head>
                ...
                <style>
                    ...
                    .custom-zoom-controls button {{
                        width: 36px; height: 36px; background-color: #ffffff; color: #333333;
                        border: 1px solid #B0BEC5; border-radius: 6px; font-size: 18px; font-weight: bold;
                        box-shadow: 0 2px 5px rgba(0,0,0,0.15); cursor: pointer;
                        display: flex; align-items: center; justify-content: center;
                    }}
                    .custom-zoom-controls button:active {{ background-color: #ECEFF1; }}
                </style>
            </head>
            <body>
...
# ==============================================================================
# SỞ CHỈ HUY GIAO DIỆN & ĐIỀU PHỐI (CẤU TRÚC 3 TRỤ CỘT)
# ==============================================================================
    ...
    def render_app(cls):
        ...
        if menu == "🏛️ 1. Phả Hệ Đại Tôn":
            ...
            export_df = df_approved[["ID", "ChaMe_ID", "HoTen", "TenTu", "GioiTinh", "DoiThu", "Chi_Nhanh", "VoChong", "NamSinh", "NamMat", "NgayGio", "GhiChu"]].rename(columns={
                "ChaMe_ID": "Mã Cha/Më", "HoTen": "Họ và Tên", "TenTu": "Tên Tự/Hiệu",
