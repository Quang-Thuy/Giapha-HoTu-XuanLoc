...
class QuanTriHinhAnh:
    #=====================================================================
    # [PHÂN LÔ D1]: Hàm con nén, tự động xoay đúng chiều và lưu trữ ảnh tải lên
    #=====================================================================
    @staticmethod
    def xu_ly_va_nen_anh(uploaded_file, save_path):
        try:
            ...
            # 🟢 Tự động xoay ảnh đúng chiều dựa trên EXIF của điện thoại (Khắc phục lỗi quay ngang)
            try:
